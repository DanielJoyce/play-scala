...
import play.scalasupport.ScalaPlugin
import play.scalasupport.Actors
...
private[cache] object ScalaCache extends CacheDelegate {
    ...
    class CacheActor extends Actor {
        ...
        override val supervisorStrategy = new OneForOneStrategy(maxNrOfRetries = 10, withinTimeRange = 10 second, trapExit = Array[Class[_]](classOf[Exception]))
    }

    private lazy val cacheActor = {
        val actor = Actors.actorSystem.actorOf(Props[CacheActor])
        actor
    }
