...
import play.test.{ FunctionalTest => F, UnitTest => UTest }
import java.util.{ Map => JMap }
import org.scalatest.{ FunSpecLike, WordSpecLike, FlatSpecLike, FunSuiteLike, FeatureSpecLike }
...
trait FunctionalSpec extends FunctionalTest with FunSpecLike with Browser with Matchers
trait FunctionalWordSpec extends FunctionalTest with WordSpecLike with Browser with Matchers
trait FunctionalFlatSpec extends FunctionalTest with FlatSpecLike with Browser with Matchers
trait FunctionalFeatureSpec extends FunctionalTest with FeatureSpecLike with Browser with Matchers

trait UnitTestCase extends UnitTest
trait UnitSpec extends UnitTest with FunSpecLike
trait UnitWordSpec extends UnitTest with WordSpecLike
trait UnitFlatSpec extends UnitTest with FlatSpecLike
trait UnitFeatureSpec extends UnitTest with FeatureSpecLike
trait UnitFunSuite extends UnitTest with FunSuiteLike
